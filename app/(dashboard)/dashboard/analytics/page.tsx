...
export default async function AnalyticsPage() {
  ...
  const stats = [
    { icon: Eye, label: "Total visites", value: totalVisits.totalDocs },
    { icon: TrendingUp, label: "Aujourd'hui", value: todayVisits.totalDocs },
    { icon: Globe, label: "Cette semaine", value: weekVisits.totalDocs },
    { icon: Clock, label: "Ce mois", value: monthVisits.totalDocs },
  ];
