  ...
  return (
    <ThemeProvider>
      <div className="min-h-screen flex items-center justify-center bg-[#13151A] px-4">
        ...
        <div className="relative z-10 w-full max-w-md pb-24">
          ...
          <form onSubmit={handleSubmit} className="dash-card p-8 space-y-6">
            ...
            <button
              type="submit"
              disabled={pending}
              className="w-full rounded-xl bg-white px-5 py-3 text-sm font-bold text-indigo-600 shadow-lg transition-all hover:-translate-y-0.5 hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center gap-2"
            >
