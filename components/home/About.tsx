...
export default function About() {
  return (
    <section className="py-12 md:py-16">
      {/* Bandeau de stats — glassmorphism */}
      <div className="container-x">
        <Reveal className="relative overflow-hidden rounded-3xl border border-[var(--border)] bg-soft px-8 py-10 md:grid-cols-4 md:divide-x md:divide-[var(--border)]">
          {/* Glow background */}
          <div className="pointer-events-none absolute -left-16 -top-16 h-48 w-48 rounded-full bg-brand-light/10 blur-[60px]" />
          <div className="pointer-events-none absolute -bottom-16 -right-16 h-48 w-48 rounded-full bg-brand-cyan/10 blur-[60px]" />
